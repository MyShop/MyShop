...
public class productTypeAction<T> extends BaseAction{
	...
	public String getProdByType()
	{
		String prodUrl = ServletActionContext.getRequest().getRequestURL().toString();
		this.type = request.getParameter("type");
		int id = Integer.parseInt(this.type);
		String hql = null;
		hql = " from Product where type1="+id+" or type2="+id+" or type3="+id;
		/*如果记录条数为0，就重新查询记录条数*/
		if(rowCount == 0)
		{
